...
%code from the algorithm described in the paper "Seeded graph matching for the correlated Wigner model via the
%projected power method". See arxiv.org/pdf/2204.04099
%Inputs: 
...
%Output:
%P              <----- permutation matrix found by PPM with iteration budget = maxiter
